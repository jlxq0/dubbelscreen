...
#      post :create, dashboard: { content: @dashboard.content, name: @dashboard.name, user_id: @dashboard.user_id }
#    end
#
...
#    patch :update, id: @dashboard, dashboard: { content: @dashboard.content, name: @dashboard.name, user_id: @dashboard.user_id }
#    assert_redirected_to dashboard_path(assigns(:dashboard))
#  end
#
